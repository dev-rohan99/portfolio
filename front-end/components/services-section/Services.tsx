    ...
    <>
        ...
        <div className="w-[100%] pb-[70px] pt-[50px]">
            <div className="container">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-[1.90rem] mt-[50px]">
                ...
                <div className="servicesCard">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#28AE60] text-center font-semibold mb-3">Full website creation</h1>
                ...
                <div className="servicesCard">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#28AE60] text-center font-semibold mb-3">Online store & shopping</h1>
                ...
                <div className="servicesCard">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#28AE60] text-center font-semibold mb-3">Bug fixing problems</h1>
