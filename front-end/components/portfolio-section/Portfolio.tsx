...
import resultapp from "../../assets/images/resultapp.png";
            ...
            <div className="container">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1.90rem] mt-[50px]">
                  ...
                  <div className="portfolioCard">
                    <Link target='_blank' href={"https://as-sunnah.netlify.app/"}>
                  ...
                  <div className="portfolioCard">
                    <Link target='_blank' href={"https://result-application.netlify.app/"}>
                      <div className="h-[200px]">
                        <Image src={resultapp} className="h-[200px] object-cover" alt=""/>
                      </div>
                    </Link>
                  ...
                  <div className="portfolioCard">
                    <Link target='_blank' href={"https://fiverr-app-clone.netlify.app/"}>
                      <div className="h-[200px]">
                        <Image src={fiverr} className="h-[200px] object-cover" alt=""/>
                      </div>
                    </Link>
