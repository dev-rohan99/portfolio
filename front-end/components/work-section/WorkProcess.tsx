            ...
            <div className="container">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1.90rem] mt-[50px]">
                ...
                <div className="workCard">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#fff] text-center font-semibold mb-3 pt-[30px]">Discussion</h1>
                ...
                <div className="workCard">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#fff] text-center font-semibold mb-3 pt-[30px]">Planning</h1>
                ...
                <div className="workCard">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#fff] text-center font-semibold mb-3 pt-[30px]">Design</h1>
                ...
                <div className="workCard2">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#fff] text-center font-semibold mb-3 pt-[30px]">Coding</h1>
                ...
                <div className="workCard2">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#fff] text-center font-semibold mb-3 pt-[30px]">Submit for Review</h1>
                ...
                <div className="workCard2">
                  ...
                  <h1 className="text-[24px] md:text-[24px] lg:text-[27px] xl:text-[27px] 2xl:text-[28px] text-[#fff] text-center font-semibold mb-3 pt-[30px]">Website Is Ready!</h1>
